%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Project: Transition Analysis: Gentlemen's Game
% Codes by @2PMGeek
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
song_title = {'Promise (I''ll Be)', 'Uneasy','Giv U Class', 'Make Love',...
    'All Night Long', 'Never', 'Humming', 'Shall We?', 'Perfume',...
    'My Last', 'Can''t Stop Feeling'};

% Data
all_song = {};
all_song{1} = [4	2	6	5	1	2	6	4	5	1	3	4	1	5	2	6	3	5	1]; %promise
all_song{2} = [6	4	5	1	4	2	3	5	1	6	3	5	2	4	3	5	6	1	4	5	4	5	1	2	3	2	6	2]; %uneasy
all_song{3} = [3	2	4	1	5	6	3	6	2	4	1	5]; %giv u class
all_song{4} = [6	4	2	5	1	3	4	2	5	6	5	1	5]; %make love
all_song{5} = [2	5	1	6	4	3	2	5	1	6	4	3	4	5	1	4]; %all night long
all_song{6} = [5	4	2	1	5	4	3	6	2	1	5	2	3	2	6	1	3	1	3	1	5	4]; %never
all_song{7} = [3	2	4	3	4	3	6	5	4	2	4	2	3	6	5	1	3	5	1	5	1	4	3	5	4	5	1	3	5	1	5]; %humming
all_song{8} = [4	6	5	1	2	5	6	1	2	5	1	5	2	5	4	3	5	1	2	5	6	5]; %how is it
all_song{9} = [4	6	2	1	5	1	2	3	2	5	1	3	4	6	2	1	5	1	3	1	5	1	2	3	2	5	1]; %perfume
all_song{10} = [4	6	1 2 1 2	5	6	1	3	1	2	5 1	4	1 4 1]; %my last
all_song{11} = [4	2	5	6	5	1	6	1	2	6	2	5	4	1	3	4	1	4	5]; %Can't stop feeling
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
