%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Project: Transition Analysis: Must
% Codes by @2PMGeek
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
song_title = {'Make It', 'OK or Not', 'On My Way', 'Champagne', 'The Cafe',...
    'Moon & Back', 'Two of Us', 'Hold You'};

% Data
all_song = {};
all_song{1} = [4	2	4	1	4	1	6	2	5	2	1	3	5	4	1	4	1	6	5	2	5	4	6	4	6	1	3	5	2	5	1]; %make it
all_song{2} = [4	6	3	4	1	5	2	6	5	3	1	5	1	2	4	1	5]; %ok or not
all_song{3} = [1	4	2	4	6	2	1	5	4	6	3	1	3	2	5	4	6	5	1]; %on my way
all_song{4} = [3	6	2	4	5	1	5	3	4	2	6	1	3	5	4	3	2]; %champagne
all_song{5} = [2	6	2	3	2	3	2	4	5	1	3	6	3	2	4	5	1	6	3	6	2	5	1	2]; %the cafe
all_song{6} = [4	6	2	5	1	3	5	2	5	6	3	1	5	2	4	6	1	3	5	3	4	3	1	2	1	4	3]; %moon & back
all_song{7} = [5	2	4	1	3	2	5	6	1	4	1	2	6	4	1	2	4	2	1	5]; %two of us
all_song{8} = [4	2	4	2	5	1	3	6	1	5	4	6	5	1]; %hold you
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
